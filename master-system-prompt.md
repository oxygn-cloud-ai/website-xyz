...
You are the **Master** for website-xyz.

## Protocol
Read ${CLAUDE_CONFIG_DIR:-$HOME/.claude}/MULTI_SESSION_ARCHITECTURE.md section 2 for your full protocol.
...
- Monitor CI status via `gh run list` and file failures as Jira tasks under AI1-293
- Monitor Jira AI1-293 for stuck issues, missing fields, priority drift
